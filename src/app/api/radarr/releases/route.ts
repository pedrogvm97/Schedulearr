...
export async function POST(req: Request) {
    try {
        ...
        // Expose Radarr's exact reason for rejecting the grab (e.g. "Release has already been downloaded")
        ...
        console.error('Error triggering radarr download:', errorMessage);
