...
import { createTvSession, getTvSession, approveTvSession, castToTvSession, getPairedTvSessions } from '@/lib/db';
    ...
    try {
        ...
        if (action === 'cast') {
            ...
            if (success) {
                ...
                return NextResponse.json({ error: 'Failed to cast to TV' }, { status: 500 });
            }
        }
