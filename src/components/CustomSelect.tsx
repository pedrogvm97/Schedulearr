...
export function CustomSelect({
    ...
    return (
        <div className={`relative w-full ${isOpen ? 'z-[999]' : ''} ${className}`} ref={containerRef}>
            {label && (
            ...
            {isOpen && (
                <div className="absolute z-[9999] top-full left-0 mt-2 min-w-[140px] max-w-[280px] w-max bg-[#09090b] backdrop-blur-2xl border border-zinc-700/80 rounded-2xl shadow-[0_25px_60px_rgba(0,0,0,0.95),0_0_0_1px_rgba(255,255,255,0.1)] overflow-hidden animate-in fade-in zoom-in-95 duration-150">
